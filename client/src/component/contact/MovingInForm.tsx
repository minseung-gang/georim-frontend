...
interface MovingInFormProps {
  state: State;
  dispatch: Dispatch<any>;
}

function MovingInForm({ state, dispatch }: MovingInFormProps) {
  return (
          ...
          <Contact.Grid className="cols-2-1">
            <div className="flex-column vertical-gap-0">
              ...
              <Contact.InputField
                ...
                value={state.movingInForm.companyName}
                onChange={(e) =>
                  dispatch({
                    type: "UPDATE_MOVING_IN_FORM_FIELD",
                    payload: {
            ...
            <div className="flex-column vertical-gap-0">
              ...
              <Contact.InputField
                ...
                value={state.movingInForm.contactName}
                onChange={(e) =>
                  dispatch({
                    type: "UPDATE_MOVING_IN_FORM_FIELD",
                    payload: {
          ...
          <Contact.Grid className="cols-2-1">
            <div className="flex-column vertical-gap-0">
              ...
              <Contact.InputField
                ...
                value={state.movingInForm.phoneNumber}
                onChange={(e) =>
                  dispatch({
                    type: "UPDATE_MOVING_IN_FORM_FIELD",
                    payload: {
            ...
            <div className="flex-column vertical-gap-0">
              ...
              <Contact.InputField
                ...
                value={state.movingInForm.email}
                onChange={(e) =>
                  dispatch({
                    type: "UPDATE_MOVING_IN_FORM_FIELD",
                    payload: {
          ...
          <Contact.Grid className="cols-2-1">
            <div className="flex-column vertical-gap-0">
              ...
              <Contact.InputField
                ...
                value={state.movingInForm.siteName}
                onChange={(e) =>
                  dispatch({
                    type: "UPDATE_MOVING_IN_FORM_FIELD",
                    payload: {
            ...
            <div className="flex-column vertical-gap-0">
              ...
              <Contact.InputField
                ...
                value={state.movingInForm.siteAddress}
                onChange={(e) =>
                  dispatch({
                    type: "UPDATE_MOVING_IN_FORM_FIELD",
                    payload: {
